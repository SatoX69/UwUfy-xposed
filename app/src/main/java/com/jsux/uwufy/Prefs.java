...
public final class Prefs {
    ...
    public static final int DEF_DELAY_MS = 1500;
    public static final String DEF_ALLOWED_PACKAGES = "";
    public static final int DEF_MIN_LENGTH = 4;
    public static final int DEF_STUTTER_PCT = 12;
    public static final int DEF_FACE_PCT = 10;
    public static final int DEF_ACTION_PCT = 8;
    public static final int DEF_EXCLAIM_PCT = 20;
